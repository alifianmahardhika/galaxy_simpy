...
class Galaxy(object):
    def __init__(self, num_stars, pos, vel, radius, thickness, color):
        ...
        sigma_mass = AVG_SOLAR_MASS / 2.0
        masses = [clamp(gauss(mu=AVG_SOLAR_MASS, sigma=sigma_mass), 
                        MIN_SOLAR_MASS, MAX_SOLAR_MASS)
        ...
        def calc_orbital_velocity(center_mass, radius): #formula of velocity
